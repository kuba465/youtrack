<div class="modal fade" tabindex="-1" role="dialog" id="createUserForm">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('main.user.create')</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="createUser" data-save="{{route('user.create')}}" class="btn btn-primary">@lang('main.user.create')</button>
            </div>
        </div>
    </div>
</div>